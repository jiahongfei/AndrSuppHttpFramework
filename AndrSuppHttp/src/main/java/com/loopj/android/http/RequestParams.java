...
public class RequestParams implements Serializable {
    ...
    /**强制使用form提交表单的形式上传参数*/
    protected boolean userMultipart;
...
//    protected final ConcurrentHashMap<String, FileWrapper> fileParams = new ConcurrentHashMap<String, FileWrapper>();
     ...
     * @param userMultipart
     */
    public void setUserMultipart(boolean userMultipart){
    	this.userMultipart = userMultipart;
    }
    ...
    public HttpEntity getEntity(ResponseHandlerInterface progressHandler) throws IOException {
        if (useJsonStreamer && !userMultipart) {
            return createJsonStreamerEntity(progressHandler);
        } else if (streamParams.isEmpty() && fileParams.isEmpty() && !userMultipart) {
